...
# 📖Reviewing my project from the trial<a name="about-project"></a>
...
- I will perform a code review for yourself on a past project.


## Description

 - In the previous lessons, I got an introduction to the code review process and I upgraded my HTML and CSS skills. That means that I am ready to perform a code review on my code!
...
> [Live Demo](https://jansuet.github.io/Reviewing my project from the trial/)
